...
if(QT_FOUND)
  ...
  if (Qt5_FOUND)
    if (TARGET Qt5::Core AND TARGET Qt5::Gui AND TARGET Qt5::Widgets AND TARGET Qt5::Svg)
      message(STATUS "Qt5 map dependencies found")
      set(QT_MAP_DEPENDENCIES_FOUND 1)
    else()
      message(STATUS "Qt5 map dependencies NOT found")
      set(QT_MAP_DEPENDENCIES_FOUND 0)
    endif()
    if (TARGET Qt5::Core AND TARGET Qt5::Gui AND TARGET Qt5::Widgets AND TARGET Qt5::Svg AND TARGET Qt5::Qml AND TARGET Qt5::Quick AND TARGET Qt5::Network AND TARGET Qt5::Location AND TARGET Qt5::Multimedia)
      message(STATUS "Qt5 client dependencies found")
      set(QT_CLIENT_DEPENDENCIES_FOUND 1)
    else()
      message(STATUS "Qt5 client dependencies NOT found")
      set(QT_CLIENT_DEPENDENCIES_FOUND 0)
    endif()
  endif()
  ...
  if (Qt6_FOUND)
    ...
    if (TARGET Qt6::Core AND TARGET Qt6::Gui AND TARGET Qt6::Widgets AND TARGET Qt6::Svg AND TARGET Qt6::Qml AND TARGET Qt6::Quick AND TARGET Qt6::Network AND TARGET Qt6::Multimedia)
