...
namespace osmscout {
  ...
  private:
    ...
    {
#ifndef NDEBUG
      // There was bug (#729, fixed 23.4.2019) that generates invalid area node index.
      // The index was unable to resolve some nodes, but it works more-or-less.
      // Skip these checks to be compatible with these databases that were distributed already...
      // TODO: remove this workaround after one year
