...
namespace osmscout {
  ...
  WaterIndex6::WaterIndex6(): WaterIndex()
  {
    // no code
  }

  WaterIndex6::~WaterIndex6()
  {
    Close();
  }
  ...
  bool WaterIndex6::GetRegions(const GeoBox& boundingBox,
  ...
  void WaterIndex6::DumpStatistics()
  {
    size_t entries=0;
    size_t memory=0;
